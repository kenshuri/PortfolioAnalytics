...
First, we take the liberty to grab some experience on the the ggplot2 package! To begin with, we plot the function and its analytical derivatives for values from 0.01 to 5.
...
```
The story behind this plot is that the more elements are added to the Taylor series, the more precisely it apporximates the real function.
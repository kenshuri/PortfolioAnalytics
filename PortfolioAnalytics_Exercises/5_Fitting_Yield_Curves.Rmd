...
We did try to fit first the observed par yield curve, and secondly, the bootstrapped spot rate curve obtained previsously.
...
It is clear that the NS model fitted the par-yield curve and not the spot rate. There is somthing I do not quite understand here.

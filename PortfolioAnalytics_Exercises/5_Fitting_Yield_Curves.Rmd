...
## 5.1 Getting started
Though we do not have access to the same data as the book, ie a collection of US Treasury bond yields as at 29 May 2009, we retrive from the [US treasury website](https://www.google.com "Daily Treasury Yield Curve Rates  from US Treasury") the daily treasury yield curve rates. Plotting this curve, we expect to get something close to the fig 5.2.
